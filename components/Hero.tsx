    ...
    return (
        <section className="relative flex items-center justify-center min-h-[70vh] px-6 overflow-hidden" id="home">
            ...
            <div className="absolute inset-0 -z-10 flex justify-center">
                <div
                    className="w-125 bg-linear-to-r from-indigo-500 via-purple-500 to-blue-500 opacity-20 blur-3xl rounded-full"/>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-8">
                ...
                >
                    ...
                    <button className="btn btn-outline" onClick={() => router.push('/cloudinary-pipeline')}>Quick Image
                        Hosting
                    </button>
                </motion.div>
